export type FREEPORTModelNavigationDirection = 'forward' | 'backward'
...
export function nextFREEPORTModelId(params: {
  modelIds: readonly string[]
  focusedId: string
  direction: FREEPORTModelNavigationDirection
}): string | null {
...
export function FREEPORTModelNavigationDirectionForKey(key: {
  name?: string
  shift?: boolean
  sequence?: string
  raw?: string
}): FREEPORTModelNavigationDirection | null {
