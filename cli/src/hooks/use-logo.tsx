...
import { LOGO, SHADOW_CHARS } from '../login/constants'
 ...
 *
 * Returns:
 * - Full ASCII FREEPORT logo for width >= 70
 * - Text variant "FREEPORT" or "FREEPORT CLI" for narrower widths
 *   (never the truncated two-letter mark — the brand is always complete)
 *
...
export const useLogo = ({
  ...
  // The full ASCII art is 6 lines tall. If the caller can't spare
