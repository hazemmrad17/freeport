export const FREEPORT_GEMINI_THINKER_AGENT_ID = 'thinker-with-files-gemini'

/** Agent id the FREEPORT WEB CHAT uses for its gemini-thinker child (see
 *  agents/thinker/thinker-gemini.ts, spawned from agents/base-chat.ts). Distinct
 *  from the CLI's FREEPORT_GEMINI_THINKER_AGENT_ID. */
export const FREEPORT_CHAT_GEMINI_THINKER_AGENT_ID = 'thinker-gemini'
...
export const FREEPORT_GEMINI_PRO_AGENT_IDS: ReadonlySet<string> = new Set([
  FREEPORT_GEMINI_THINKER_AGENT_ID,
  FREEPORT_CHAT_GEMINI_THINKER_AGENT_ID,
])

export const FREEPORT_GEMINI_THINKER_SYSTEM_INSTRUCTION =
...
export const FREEPORT_GEMINI_THINKER_INSTRUCTIONS_PROMPT =
