...
export const FREEPORT_ONBOARDING_QUESTIONS: readonly OnboardingQuestion[] = [
  {
    id: 'referral_source',
    prompt: 'Where did you hear about FREEPORT?',
  ...
  {
    id: 'intended_use',
    prompt: 'What will you build with FREEPORT?',
    options: [
...
export function validateOnboardingSubmission(
  ...
  questions: readonly OnboardingQuestion[] = FREEPORT_ONBOARDING_QUESTIONS,
