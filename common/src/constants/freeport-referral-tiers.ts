/**
 * FREEPORT referral program constants.
 *
 ...
 * the session pools in FREEPORT-models.ts — and the "Powered by FREEPORT"
...
/**
 * FREEPORT CLI limited-tier perk: each qualified referral whose referred user
 ...
 */
export const FREEPORT_WEB_REFERRAL_LIMIT = 20
 ...
 */
export const FREEPORT_REFERRAL_SIGNUP_LIMIT = 100
