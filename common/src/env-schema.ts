...
// Bun will inject all these values or use sensible defaults for standalone freeport
export const clientProcessEnv: ClientInput = {
  ...
  NEXT_PUBLIC_POSTHOG_API_KEY:
    process.env.NEXT_PUBLIC_POSTHOG_API_KEY ?? 'dummy_posthog_key',
  ...
  NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY:
    process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY ?? 'pk_dummy_key',
  NEXT_PUBLIC_STRIPE_CUSTOMER_PORTAL:
    process.env.NEXT_PUBLIC_STRIPE_CUSTOMER_PORTAL ?? 'https://freeport.dev/portal',
